...
python Experiments.py run-exp -n exp_tr_64 --epochs 20 --bs-train 64 --batches 5000 --seed 42 --early-stopping 25 --model-name dias_model --lr 0.001;
#
echo "Sys Model"
echo "Training resnet experiment"

python Experiments.py run-exp -n exp_tr_64 --epochs 20 --bs-train 64 --batches 5000 --seed 42 --early-stopping 25 --model-name sys_model --lr 0.001;

echo "Dense Net Experiment"
echo "Dias Model"
echo "Training experiment"

python Experiments.py run-exp -n exp_tr_64_b_5000 --epochs 3 --bs-train 64 --batches 5000 --seed 42 --early-stopping 100 --model-name dias_model --lr 0.003 --scheduler True;
...
python Experiments.py run-exp -n exp_tr_64_b_5000 --epochs 3 --bs-train 64 --batches 5000 --seed 42 --early-stopping 100 --model-name sys_model --lr 0.003 --scheduler True;
